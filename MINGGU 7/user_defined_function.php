<?php 
    ...
    salam5();                         // Output: Selamat Malam, Anton
    salam5("Pagi");                   // Output: Selamat Pagi, Anton
    salam5("Datang", "Pak Presiden!"); // Output: Selamat Datang, Pak Presiden!

    // Anonymous Function
    $salam = function () {
        return "Selamat Siang";
    };
    echo $salam(); // Output: Selamat Siang
