<?php
    ...
    // Array bulan untuk opsi dropdown
    $arr_month = [
        "1" => "Januari",
        "2" => "Februari",
        "3" => "Maret",
    ...
    // Pesan error untuk validasi form
    $error_message = "";

    // Menghandle pengiriman form
    if (isset($_POST["submit"])) {
        // Mengambil nilai dari form dan membersihkannya
        ...
        // Menyesuaikan input gender dengan teks yang lebih jelas
        $checked_man = ""; 
        $checked_woman = "";
        ...
        // Menyesuaikan checkbox skill yang dipilih
        ...
        // (berlanjut)
        // Proses pengecekan untuk skill CSS, JavaScript, PHP, MySQL, Laravel, dan React Native

        // Jika tidak ada pesan error, maka proses registrasi dilanjutkan
        if ($error_message === "") {
            ...
            // Memasukkan data ke dalam database (file registration_process.php)
            include("registration_process.php");
            die(); // Menghentikan proses eksekusi skrip setelah registrasi berhasil
        }
    } else {
        // Menyiapkan nilai default untuk form jika belum diisi atau saat pertama kali diakses
        $student_name = "";
        $student_number = "";
        $student_address = "";
            ...
            <fieldset class="form-element">
                ...
                <table>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <input type="text" name="student_name" value="<?= $student_name ?>" size="20" placeholder="Masukan Nama Anda">
                        </td>
                    </tr>
                    <tr>
                        <td>No Induk Mahasiswa (NIM)*</td>
                        <td>:</td>
                        <td><input type="text" name="student_number" value="<?= $student_number ?>" size="20" placeholder="Masukan NIM Anda"></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: top;">Alamat Mahasiswa*</td>
                        <td style="vertical-align: top;">:</td>
                        <td><textarea name="student_address" cols="30" rows="5" placeholder=" Masukan Alamat Anda"><?= $student_address ?></textarea></td>
                    </tr>
                    <tr>
                        <td>Tanggal Lahir*</td>
                        <td>:</td>
                        <td class="tanggal-lahir">
                    ...
                    <tr>
                        ...
                        <td class="gender-container">
                            <input type="radio" name="student_gender" value="man" id="pria" <?php echo $checked_man  ?>>
                            <label for="pria">Pria</label>
                            <input type="radio" name="student_gender" value="woman" id="wanita" <?php echo $checked_woman  ?>>
